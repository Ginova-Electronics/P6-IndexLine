...
Download the software (machine and PC - software) from here: [Version 2.0.0](https://github.com/Ginova-Electronics/P6-IndexLine/releases/download/2.0.0/P6.2.0.0.zip)
...
- **PC (P6 Suite)**: Contains the compatible PC software (Windows) **P6 Suite** for, available with and without SCADA.
...
Laden Sie die Software (Maschinen- und PC-Software) hier herunter: [Version 2.0.0](https://github.com/Ginova-Electronics/P6-IndexLine/releases/download/2.0.0/P6.2.0.0.zip)
...
Téléchargez le logiciel (logiciel machine et PC) ici: [Version 2.0.0](https://github.com/Ginova-Electronics/P6-IndexLine/releases/download/2.0.0/P6.2.0.0.zip)
